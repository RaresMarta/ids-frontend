    ...
    <div className="min-h-screen bg-background flex">
      ...
      <main className="flex-1 flex flex-col min-h-screen overflow-hidden">
        <header className="flex items-center justify-between px-8 py-5 border-b border-border shrink-0">
          <div>
            <h2 className="font-display text-lg text-foreground">Analysis</h2>
            <p className="text-xs text-muted-foreground mt-0.5">Classifier overview and analysis history</p>
          </div>
          <button
            onClick={() => navigate('/analysis/classify')}
            className="inline-flex items-center gap-2 px-4 py-2 bg-foreground text-background text-sm rounded-md hover:opacity-90 transition-opacity shrink-0"
          >
